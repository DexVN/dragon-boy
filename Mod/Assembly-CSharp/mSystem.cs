...
{
	// Token: 0x06000109 RID: 265 RVA: 0x00006F96 File Offset: 0x00005396
	public static void AddIpTest()
	{
	}

	// Token: 0x0600010A RID: 266 RVA: 0x00006F98 File Offset: 0x00005398
	public static void resetCurInapp()
	{
		mSystem.curINAPP = 0;
	}

	// Token: 0x0600010B RID: 267 RVA: 0x00006FA0 File Offset: 0x000053A0
	...
	// Token: 0x0600010C RID: 268 RVA: 0x00006FBA File Offset: 0x000053BA
	...
	// Token: 0x0600010D RID: 269 RVA: 0x00006FD4 File Offset: 0x000053D4
	...
	// Token: 0x0600010E RID: 270 RVA: 0x000074D8 File Offset: 0x000058D8
	...
	// Token: 0x0600010F RID: 271 RVA: 0x000075E0 File Offset: 0x000059E0
	...
	// Token: 0x06000110 RID: 272 RVA: 0x0000779C File Offset: 0x00005B9C
	public static void callHotlinePC()
	{
		Application.OpenURL("http://ngocrongonline.com/");
	}

	// Token: 0x06000111 RID: 273 RVA: 0x000077A8 File Offset: 0x00005BA8
	public static void callHotlineJava()
	{
	}

	// Token: 0x06000112 RID: 274 RVA: 0x000077AA File Offset: 0x00005BAA
	public static void callHotlineIphone()
	{
	}

	// Token: 0x06000113 RID: 275 RVA: 0x000077AC File Offset: 0x00005BAC
	public static void callHotlineWindowsPhone()
	{
	}

	// Token: 0x06000114 RID: 276 RVA: 0x000077AE File Offset: 0x00005BAE
	public static void closeBanner()
	{
	}

	// Token: 0x06000115 RID: 277 RVA: 0x000077B0 File Offset: 0x00005BB0
	public static void showBanner()
	{
	}

	// Token: 0x06000116 RID: 278 RVA: 0x000077B2 File Offset: 0x00005BB2
	public static void createAdmob()
	{
	}

	// Token: 0x06000117 RID: 279 RVA: 0x000077B4 File Offset: 0x00005BB4
	public static void checkAdComlete()
	{
	}

	// Token: 0x06000118 RID: 280 RVA: 0x000077B6 File Offset: 0x00005BB6
	public static void paintPopUp2(mGraphics g, int x, int y, int w, int h)
	{
		g.fillRect(x, y, w + 10, h, 0, 90);
	}

	// Token: 0x06000119 RID: 281 RVA: 0x000077C9 File Offset: 0x00005BC9
	...
	// Token: 0x0600011A RID: 282 RVA: 0x000077D8 File Offset: 0x00005BD8
	...
	// Token: 0x0600011B RID: 283 RVA: 0x00007868 File Offset: 0x00005C68
	...
	// Token: 0x0600011C RID: 284 RVA: 0x000078A5 File Offset: 0x00005CA5
	...
	// Token: 0x0600011D RID: 285 RVA: 0x000078B4 File Offset: 0x00005CB4
	...
	// Token: 0x0600011E RID: 286 RVA: 0x000078E8 File Offset: 0x00005CE8
	...
	// Token: 0x0600011F RID: 287 RVA: 0x0000790C File Offset: 0x00005D0C
	...
	// Token: 0x06000120 RID: 288 RVA: 0x0000795C File Offset: 0x00005D5C
	...
	// Token: 0x06000121 RID: 289 RVA: 0x00007990 File Offset: 0x00005D90
	public static int currentHour()
	{
		return DateTime.Now.Hour;
	}

	// Token: 0x06000122 RID: 290 RVA: 0x000079AA File Offset: 0x00005DAA
	public static void println(object str)
	{
		Debug.Log(str);
	}

	// Token: 0x06000123 RID: 291 RVA: 0x000079B2 File Offset: 0x00005DB2
	...
	// Token: 0x06000124 RID: 292 RVA: 0x000079BF File Offset: 0x00005DBF
	...
	// Token: 0x06000125 RID: 293 RVA: 0x000079DA File Offset: 0x00005DDA
	public static void onConnectOK()
	{
		Controller.isConnectOK = true;
	}

	// Token: 0x06000126 RID: 294 RVA: 0x000079E2 File Offset: 0x00005DE2
	public static void onConnectionFail()
	{
		Controller.isConnectionFail = true;
	}

	// Token: 0x06000127 RID: 295 RVA: 0x000079EA File Offset: 0x00005DEA
	public static void onDisconnected()
	{
		Controller.isDisconnected = true;
	}

	// Token: 0x06000128 RID: 296 RVA: 0x000079F2 File Offset: 0x00005DF2
	public static void exitWP()
	{
	}

	// Token: 0x06000129 RID: 297 RVA: 0x000079F4 File Offset: 0x00005DF4
	...
	// Token: 0x0600012A RID: 298 RVA: 0x00007CE4 File Offset: 0x000060E4
	public static void endKey()
	{
	}

	// Token: 0x0600012B RID: 299 RVA: 0x00007CE8 File Offset: 0x000060E8
	...
	// Token: 0x0600012C RID: 300 RVA: 0x00007D4C File Offset: 0x0000614C
