...
{
	// Token: 0x0600000C RID: 12 RVA: 0x0000218C File Offset: 0x0000058C
	...
	// Token: 0x0600000D RID: 13 RVA: 0x000021CB File Offset: 0x000005CB
	public DataInputStream(sbyte[] data)
	{
		this.r = new myReader(data);
	}

	// Token: 0x0600000E RID: 14 RVA: 0x000021DF File Offset: 0x000005DF
	...
	// Token: 0x0600000F RID: 15 RVA: 0x00002207 File Offset: 0x00000607
	public static DataInputStream getResourceAsStream(string filename)
	{
		return DataInputStream.__getResourceAsStream(filename);
	}

	// Token: 0x06000010 RID: 16 RVA: 0x00002210 File Offset: 0x00000610
	...
	// Token: 0x06000011 RID: 17 RVA: 0x000022E0 File Offset: 0x000006E0
	...
	// Token: 0x06000012 RID: 18 RVA: 0x00002314 File Offset: 0x00000714
	public short readShort()
	{
		return this.r.readShort();
	}

	// Token: 0x06000013 RID: 19 RVA: 0x00002321 File Offset: 0x00000721
	public int readInt()
	{
		return this.r.readInt();
	}

	// Token: 0x06000014 RID: 20 RVA: 0x0000232E File Offset: 0x0000072E
	public int read()
	{
		return (int)this.r.readUnsignedByte();
	}

	// Token: 0x06000015 RID: 21 RVA: 0x0000233B File Offset: 0x0000073B
	public void read(ref sbyte[] data)
	{
		this.r.read(ref data);
	}

	// Token: 0x06000016 RID: 22 RVA: 0x0000234A File Offset: 0x0000074A
	public void close()
	{
		this.r.Close();
	}

	// Token: 0x06000017 RID: 23 RVA: 0x00002357 File Offset: 0x00000757
	public void Close()
	{
		this.r.Close();
	}
	...
	// Token: 0x06000019 RID: 25 RVA: 0x00002371 File Offset: 0x00000771
	public sbyte readByte()
	{
		return this.r.readByte();
	}

	// Token: 0x0600001A RID: 26 RVA: 0x0000237E File Offset: 0x0000077E
	public long readLong()
	{
		return this.r.readLong();
	}

	// Token: 0x0600001B RID: 27 RVA: 0x0000238B File Offset: 0x0000078B
	public bool readBoolean()
	{
		return this.r.readBoolean();
	}

	// Token: 0x0600001C RID: 28 RVA: 0x00002398 File Offset: 0x00000798
	public int readUnsignedByte()
	{
		return (int)((byte)this.r.readByte());
	}

	// Token: 0x0600001D RID: 29 RVA: 0x000023A6 File Offset: 0x000007A6
	public int readUnsignedShort()
	{
		return (int)this.r.readUnsignedShort();
	}

	// Token: 0x0600001E RID: 30 RVA: 0x000023B3 File Offset: 0x000007B3
	public void readFully(ref sbyte[] data)
	{
		this.r.read(ref data);
	}

	// Token: 0x0600001F RID: 31 RVA: 0x000023C2 File Offset: 0x000007C2
	public int available()
	{
		return this.r.available();
	}

	// Token: 0x06000020 RID: 32 RVA: 0x000023CF File Offset: 0x000007CF
